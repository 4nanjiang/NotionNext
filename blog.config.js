...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Ready2Death', // 您的昵称 例如 tangly1024
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-872S23Y40X', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
